...
(2, 'Books', NULL, '[{"name": "author", "type": "string", "required": true}, {"name": "genre", "type": "string"}]'),
(3, 'Clothing', NULL, '[{"name": "size", "type": "string", "required": true, "options": ["XS", "S", "M", "L", "XL", "XXL"]}, {"name": "material", "type": "string"}]'),
(4, 'Sports', NULL, '[{"name": "sport_type", "type": "string", "required": true}, {"name": "weight_kg", "type": "number"}]');

INSERT INTO category (id, name, parent_id, attribute_definitions)
VALUES
(5, 'TVs', 1, '[{"name": "screen_size_inch", "type": "number", "required": true}, {"name": "resolution", "type": "string", "options": ["4K", "8K", "Full HD"]}]'),
(6, 'PCs', 1, '[{"name": "ram_gb", "type": "number", "required": true}, {"name": "cpu", "type": "string", "required": true}]'),
(7, 'Phones', 1, '[{"name": "storage_gb", "type": "number", "required": true, "options": [64, 128, 256, 512, 1024]}, {"name": "dual_sim", "type": "boolean"}]'),
(8, 'Earphones', 1, '[{"name": "type", "type": "string", "options": ["In-ear", "Over-ear", "On-ear"]}, {"name": "wireless", "type": "boolean", "required": true}]'),
(9, 'E-Books', 2, '[{"name": "file_format", "type": "string", "options": ["EPUB", "PDF", "MOBI"]}]'),
